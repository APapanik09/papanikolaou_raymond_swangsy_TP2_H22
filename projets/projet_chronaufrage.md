...
L'oeuvre s'active selon la position et les mouvements de l'intéracteur.trice, par exemple lorsque ce dernier s'arrête devant l'un des tableaux, celui-ci va commencer à s'animer selon ou est positionné l'interacteur.trice et ses mouvements.
...
Le cours d'espace interactif est nécessaire pour ce projet, car les élèves de 3e veulent que la présence d'un interacteur.trice sois primordial afin, que le projet soi en marche. Ce cours va permettre aux élèves de ce projet de "concevoir, programmer et intégrer des objets interactifs dans un environnement réel"
</br>
